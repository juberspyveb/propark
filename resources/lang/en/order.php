...
return [
    ...
    'access_denied_bespoke' => "You can't access bespoke.",
    'access_denied' => "Access Denied.",
    'your_order_is_in_production' => 'Order #:orderNumber <br> Thank you! <br> Your order has now been sent to production',
    'your_order_is_already_in_production' => 'Order: #:orderNumber <br> Your order has already in production.',
    'your_order_is_in_review_proof' => 'Order: #:orderNumber <br> Thank you for your feedback! <br> We will be in touch shortly with an update.',
    'your_order_is_already_in_review_proof' => 'Order: #:orderNumber <br> You have already provided your feedback.',
    'order_product_sc_type_number_error' => 'Please enter your house :type',
    'order_product_sc_length_error' => 'Maximum characters are :length',
    'required_house_number' => 'Please enter your house number',
    'required_house_name' => 'Please enter your house name',
